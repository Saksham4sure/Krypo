...
const BalanceCard = ({ title, amount, subText }) => {
    ...
    return (
        <div className='flex items-center justify-between p-4 shadow-sm rounded-xl border-[#E7E6E9] border w-[270px] bg-[#EEEEEE]'>
            <div className='flex flex-col'>
                <h1 className='text-sm font-light'>{title}</h1>
                <h1 className='text-2xl font-semibold text-[#222222]'>Rs. {hidden ? "XXX.XX" : `${amount}`}</h1>
